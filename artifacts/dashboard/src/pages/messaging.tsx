...
export default function Messaging() {
  ...
  return (
    <div className="p-6 space-y-4">
      <div>
        <h1 className="text-lg font-bold text-foreground tracking-tight">Messaging Hub</h1>
        <p className="text-xs text-muted-foreground mt-0.5">Send post-call messages via WhatsApp, Telegram, and Email</p>
      </div>
      ...
      <Tabs defaultValue="whatsapp">
        ...
        <TabsContent value="whatsapp" className="mt-4">
          <div className="bg-card border border-card-border rounded p-4 max-w-md space-y-3">
